 ...
 */
static void ST7735S_InitController(void)
{
...
void LCD_X_Config(void)
{
    ...
    //
    PortAPI.pfWrite8_A0  = mtb_st7735s_write_command;
    PortAPI.pfWrite8_A1  = mtb_st7735s_write_data;
    PortAPI.pfWriteM8_A1 = mtb_st7735s_write_data_stream;
